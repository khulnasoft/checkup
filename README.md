...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg?style=flat-square)](https://godoc.org/github.com/khulnasoft/checkup) [![Sourcegraph](https://sourcegraph.com/github.com/khulnasoft/checkup/-/badge.svg)](https://sourcegraph.com/github.com/khulnasoft/checkup?badge)
...
Checkup was created by Matt Holt, author of the [Caddy web server](https://caddyserver.com). It is maintained and sponsored by [Sourcegraph](https://sourcegraph.com). If you'd like to dive into the source, you can [start here](https://sourcegraph.com/github.com/khulnasoft/checkup/-/def/GoPackage/github.com/khulnasoft/checkup/-/Checkup).
...
[Download Checkup](https://github.com/khulnasoft/checkup/releases/latest) for your platform and put it in your PATH, or install from source:

```bash
$ go get -u github.com/khulnasoft/checkup/cmd/checkup
```
...
We will show JSON samples below, to get you started. **But please [refer to the godoc](https://godoc.org/github.com/khulnasoft/checkup) for a comprehensive description of each type of checker, storage, and notifier you can configure!**

Here are the configuration structures you can use, which are explained fully [in the godoc](https://godoc.org/github.com/khulnasoft/checkup). **Only the required fields are shown, so consult the godoc for more.**

#### HTTP Checker

**[godoc: check/http](https://godoc.org/github.com/khulnasoft/checkup/check/http)**
...
**[godoc: check/tcp](https://godoc.org/github.com/khulnasoft/checkup/check/tcp)**
...
**[godoc: check/dns](https://godoc.org/github.com/khulnasoft/checkup/check/dns)**
...
**[godoc: check/tls](https://godoc.org/github.com/khulnasoft/checkup/check/tls)**
...
**[godoc: check/exec](https://godoc.org/github.com/khulnasoft/checkup/check/exec)**
...
**[godoc: S3](https://godoc.org/github.com/khulnasoft/checkup/check/s3)**
...
**[godoc: FS](https://godoc.org/github.com/khulnasoft/checkup/storage/fs)**
...
**[godoc: GitHub](https://godoc.org/github.com/khulnasoft/checkup/storage/github)**
...
**[godoc: storage/mysql](https://godoc.org/github.com/khulnasoft/checkup/storage/mysql)**
...
**[godoc: storage/sqlite3](https://godoc.org/github.com/khulnasoft/checkup/storage/sqlite3)**
...
**[godoc: storage/postgres](https://godoc.org/github.com/khulnasoft/checkup/storage/postgres)**
...
**[godoc: appinsights](https://godoc.org/github.com/khulnasoft/checkup/storage/appinsights)**
...
If you'd rather do this manually, see the [instructions on the wiki](https://github.com/khulnasoft/checkup/wiki/Provisioning-S3-Manually) but keeping in mind the region must be **US Standard**.
...
In statuspage/js, use the contents of [config_s3.js](https://github.com/khulnasoft/checkup/blob/master/statuspage/js/config_s3.js) to fill out [config.js](https://github.com/khulnasoft/checkup/blob/master/statuspage/js/config.js), which is used by the status page.
...
Then `go get github.com/khulnasoft/checkup` and import it.
...
First, `go get github.com/khulnasoft/checkup` and import it. Then configure it:
...
```bash
git clone git@github.com:khulnasoft/checkup.git
cd checkup
make
```
